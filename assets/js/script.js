...
if (!fs.existsSync(`${root}/database.json`)) fs.writeFileSync(`${root}/database.json`, '{"music":[], "settings": [{"noti": {"turn": false, "loved": false, "add": false}, "key": { "play": "ctrl+Space", "random": "ctrl+r", "love": "ctrl+l", "next": "ctrl+Right", "prev": "ctrl+Left", "focus": "ctrl+Up", "mini": "ctrl+Down", "volumeup": "ctrl+=", "volumedown": "ctrl+-", "mute": "ctrl+-"}}]}');
